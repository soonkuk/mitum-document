...
type CreateBlockcityHistoryDocumentCommand struct {
	*BaseCommand
...
func NewCreateBlockcityHistoryDocumentCommand() CreateBlockcityHistoryDocumentCommand {
	return CreateBlockcityHistoryDocumentCommand{
		BaseCommand: NewBaseCommand("create-blockcity-history-document-operation"),
	}
}

func (cmd *CreateBlockcityHistoryDocumentCommand) Run(version util.Version) error {
...
func (cmd *CreateBlockcityHistoryDocumentCommand) parseFlags() error {
...
func (cmd *CreateBlockcityHistoryDocumentCommand) createOperation() (operation.Operation, error) {
	...
	if err != nil {
		return nil, errors.Errorf("failed to create create-blockcity-history-document operation operation: %q", err)
	}
	return op, nil
}
